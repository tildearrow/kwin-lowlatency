# What? KWin-lowlatency is changing!

...

KWin-lowlatency evolved into...

**KWin-fixes!**

# KWin-fixes

this is KWin, but with some changes I applied for (mostly) personal reasons.
it formerly was my attempt to reduce latency and stuttering in the popular KWin compositor used in KDE, but in Plasma 5.21 the developers [merged official patches](https://invent.kde.org/plasma/kwin/-/merge_requests/507) which rewrite great parts of the compositing code, making my changes unnecessary.

## Geometry tip

[a change in Plasma 5.24](https://invent.kde.org/plasma/kwin/-/commit/fcf0b4796f55fc15aa60a339ea40cdbb4573f9b8) removed the "Display window geometries on move/resize" setting, which was useful to me when I wanted to resize a window to a very specific size.

KWin-fixes reverts this change and therefore brings the option back.

## Close in Present Windows



## Paint cursor

an effect for usage with darmstadt or any other screen capture software that doesn't capture the cursor.

also adds some motion blur to your cursor (optional).

## X11 unredirection

lowers latency in full-screen applications and brings back tearing when VSync is off.

## XWayland and HiDPI

**COMING SOON!** a change is applied for XWayland apps which makes the XWayland server run at the correct resolution (rather than the logical resolution) so XWayland apps don't look blurry and are able to take advantage of the entire screen.
...
a new Feature can only be added to KWin-fixes if:

 * it fits my coding style
 * it does not introduce instabilities
 * it works together with all existing features
 * it adds any advantage
 * it is a special case for a small user group (it is the point of this fork)
 * it does not increase code complexity significantly
 * it does not affect KWin-fixes' license (GPLv2+)

it is Doubtful I am going to Request Upstreaming any of the features in KWin-fixes.
